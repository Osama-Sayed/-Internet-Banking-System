...
<form  method="post" autocomplete="off" id="ClientRegistrationForm" runat="server">
  <div class="container">
    ...
    <br>
	<asp:TextBox ID="EmailCR" runat="server" type="email" placeholder="E-mail*" name="clientemail" title="The email format must be valid" required  oninvalid="this.setCustomValidity('Email format must be valid')" OnTextChanged="EmailCR_TextChanged" ></asp:TextBox> 
	<br>
