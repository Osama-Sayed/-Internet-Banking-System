...
<body>
  ...
  <div class="container">
	...
	<br>
	<asp:TextBox ID="AmountTM" runat="server" type="text" placeholder="Amount*" name="Amount" pattern="[0-9]+" title="An Amount can't have characters or special character" required ></asp:TextBox>
	<br>
